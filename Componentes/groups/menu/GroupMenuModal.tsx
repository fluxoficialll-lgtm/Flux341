...
interface GroupMenuModalProps {
    ...
    onLeave: () => void;
    isCreator: boolean;
    isAdmin?: boolean; // Adicionado para controle refinado
}
...
export const GroupMenuModal: React.FC<GroupMenuModalProps> = ({
    ...
    const options = [
        ...
        // Apenas Admins ou Donos podem limpar mensagens globais ou acessar configurações
        canManage ? { label: 'Limpar Mensagens', icon: 'fa-solid fa-broom', onClick: onClear } : null,
        canManage ? { label: 'Configurações', icon: 'fa-solid fa-gear', onClick: onSettings } : null,
